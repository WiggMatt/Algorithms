...
public class Graph {
    private final int MAX_VERT = 10;// максимальное количество вершин
    private final int INFINITY = 100000000; // это число служит в качестве "бесконечности"
    private Vertex vertexList[]; // список вершин
    private int relationMatrix[][]; // матрица смежности
    ...
    public Graph() {
        vertexList = new Vertex[MAX_VERT]; // матрица смежности
        relationMatrix = new int[MAX_VERT][MAX_VERT];
        countOfVertices = 0;
        countOfVertexInTree = 0;
        for (int i = 0; i < MAX_VERT; i++) {// матрица смежности заполняется бесконечными расстояниями
    ...
    public void addVertex(char c) {// задание новых вершин
        vertexList[countOfVertices++] = new Vertex(c);
    }
    ...
    public void findShortestPath() { // выбор кратчайшего пути
